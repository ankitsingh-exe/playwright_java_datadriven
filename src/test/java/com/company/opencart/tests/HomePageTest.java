...
import com.company.listeners.ExtendReportListeners;
...
public class HomePageTest extends BaseTest {
    ...
    public void validateHomePageTitleTest(){
        Assert.assertEquals(homePage.getHomePageTitle(), AppConstants.HOME_PAGE_TITLE, "Incorrect home page title");
    }
